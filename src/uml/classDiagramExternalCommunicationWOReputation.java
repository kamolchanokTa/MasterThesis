...
public class classDiagramExternalCommunicationWOReputation {
...
package verificationScenario {
	...
	interface IPlatoonPlanVerificationScenario << Singleton >>[[java:verificationScenarios.IPlatoonPlanVerificationScenario]] {
		void verifyReceivingTime(Date receivingTime,...)
		void verifyPosition(double lvSpeed,...)
	}
	
	interface IV2VInputVerificationScenario << Singleton >> [[java:verificationScenarios.IV2VInputVerificationScenario]] {
	...
	interface IVehicleIdentityVerificationScenario << Singleton >> [[java:verificationScenarios.IVehicleIdentityVerificationScenario]] {
